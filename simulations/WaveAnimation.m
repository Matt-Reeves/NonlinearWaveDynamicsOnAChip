...
function WaveAnimation(simparams,solution,simgrids,savename,savedir)
%load('WhatIsThis3.mat')

%%
N = simparams.N;
Nt = simparams.Nt;
time = (1:Nt)*simparams.DT;

x = squeeze(solution.Q(:,1,:));
y = squeeze(solution.Q(:,2,:));
