function doglegTest(N,d,Ac,waveType,kappa)
%clear 
%clc
%close all
%global figHandle axesHandle
...
simparams = simparams_initialize(N,d,waveType,Ac,kappa);
...
savedir  = ['./data/' simparams.waveType '/d' num2str(simparams.d) '/'];
