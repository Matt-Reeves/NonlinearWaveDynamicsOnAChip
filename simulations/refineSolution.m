function [sol,simparams] = refineSolution(loadfile,N2)
load(loadfile,'sol','simparams') %ok
...
simparams = simparams_initialize(N2,simparams.d,simparams.waveType,simparams.Act,simparams.kappa);
